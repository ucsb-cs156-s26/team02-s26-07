...
public class ArticlesControllerTests extends ControllerTestCase {
    ...
    mockMvc
        .perform(
            post("/api/articles/post")
                ...
                .param("explanation", "This is a article for TEST")
                .param("email", "test_email@test.com")
  ...
  public void logged_in_user_can_get_all_ucsbdates() throws Exception {
    ...
    ArrayList<Articles> expected = new ArrayList<>();
    expected.addAll(Arrays.asList(article1, article2));

    when(articlesRepository.findAll()).thenReturn(expected);
  ...
  public void admin_can_edit_an_existing_ucsbdate() throws Exception {
    ...
    String requestBody = mapper.writeValueAsString(article_edit);

    when(articlesRepository.findById(eq(67L))).thenReturn(Optional.of(article_orig));
    ...
    verify(articlesRepository, times(1)).save(article_edit); // should be saved with correct user
    String responseString = response.getResponse().getContentAsString();
