...
public class HelpRequestWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_helprequest() throws Exception {
    ...
    page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("Table 7");
    page.getByTestId("HelpRequestForm-requestTime").fill("2024-01-01T12:00");
    page.getByTestId("HelpRequestForm-explanation").fill("Need help with React state");
    ...
    page.getByTestId("HelpRequestForm-requesterEmail").fill("updated@ucsb.edu");
    page.getByTestId("HelpRequestForm-submit").click();

    assertThat(page.getByTestId("HelpRequestsTable-cell-row-0-col-requesterEmail"))
        .hasText("updated@ucsb.edu");

    page.getByTestId("HelpRequestsTable-cell-row-0-col-Delete-button").click();

    assertThat(page.getByTestId("HelpRequestsTable-cell-row-0-col-explanation")).not().isVisible();
  }
