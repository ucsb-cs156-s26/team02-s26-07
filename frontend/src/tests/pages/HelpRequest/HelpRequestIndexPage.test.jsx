...
describe("HelpRequestIndexPage tests", () => {
  ...
  test("renders three help requests correctly for regular user", async () => {
    ...
    const email = screen.getByText("wyattearp2004@gmail.com");
    expect(email).toBeInTheDocument();

    const explanation = screen.getByText("I need help with blah blah blah");
  ...
  test("what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, "HelpRequest with id 3 was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toBeCalledWith("HelpRequest with id 3 was deleted");
    });
